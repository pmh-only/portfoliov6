  ...
  <article id="actions" className={style.container}>
    ...
    <div className={style.outer}>
      <div className={style.actions}>
        <div style={{ backgroundImage: 'url("/actions1.jpg")' }}>
          <h2>1회 창의융합 <strong>해커톤 대회 우수</strong></h2>
        </div>
        <div style={{ backgroundImage: 'url("/actions2.jpg")' }}>
          <h2>2회 창의융합 <strong>해커톤 대회 최우수</strong></h2>
        </div>
        <div style={{ backgroundImage: 'url("/actions3.jpg")' }}>
          <h2>취업대박람회 <strong>창업경진대회 표창</strong></h2>
        </div>
        <div style={{ backgroundImage: 'url("/actions4.jpg")' }}>
          <h2>2021 경북<strong>기능경기대회 금메달</strong></h2>
        </div>
        <div style={{ backgroundImage: 'url("/actions5.jpg")' }}>
          <h2>2021 <strong>전국기능경기대회 우수상</strong></h2>
        </div>
        <div style={{ backgroundImage: 'url("/actions6.jpg")' }}>
